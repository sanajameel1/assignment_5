...
# Initialize failed_attempts in session_state if not already initialized
...
def decrypt_data(encrypted_text, passkey):
    ...
    st.session_state.failed_attempts += 1  # Increment failed attempts if decryption fails
    return None
